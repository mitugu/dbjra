...
File.open("./PACI190330/UKC190330.txt", "r", :encoding => "SJIS"
) do |fin|

  File.open("../data/j_ukc/ukc190330.csv", "w") do |fout|
...
puts "LOAD DATA LOCAL INFILE '../data/j_ukc/ukc190330.csv' INTO TABLE ukcs FIELDS TERMINATED BY ',' LINES TERMINATED BY '\\n' (#{column_names_str});"
